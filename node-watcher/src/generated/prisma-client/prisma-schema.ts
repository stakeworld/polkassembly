...
type AggregateFellowshipReferendum {
  count: Int!
}

type AggregateFellowshipReferendumStatus {
  count: Int!
}
...
type AggregatePreimageArgumentV2 {
  count: Int!
}
...
type AggregatePreimageStatusV2 {
  count: Int!
}

type AggregatePreimageV2 {
  count: Int!
}
...
type AggregateReferendumStatusV2 {
  count: Int!
}

type AggregateReferendumV2 {
  count: Int!
}
...
type FellowshipReferendum {
  ...
  preimageHash: String!
  referendumId: Int!
  referendumStatus(where: FellowshipReferendumStatusWhereInput, orderBy: FellowshipReferendumStatusOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [FellowshipReferendumStatus!]
  enactmentAt: String
...
type FellowshipReferendumConnection {
  pageInfo: PageInfo!
  edges: [FellowshipReferendumEdge]!
  aggregate: AggregateFellowshipReferendum!
}

input FellowshipReferendumCreateInput {
  trackNumber: Int!
  origin: String!
  preimage: PreimageV2CreateOneWithoutFellowshipreferendumInput
  preimageHash: String!
  referendumId: Int!
  referendumStatus: FellowshipReferendumStatusCreateManyWithoutReferendumInput
  enactmentAt: String
  enactmentAfter: String
  submittedAt: String!
  submitted: Json
...
input FellowshipReferendumCreateOneWithoutPreimageInput {
  create: FellowshipReferendumCreateWithoutPreimageInput
  connect: FellowshipReferendumWhereUniqueInput
}

input FellowshipReferendumCreateOneWithoutReferendumStatusInput {
  create: FellowshipReferendumCreateWithoutReferendumStatusInput
  connect: FellowshipReferendumWhereUniqueInput
}

input FellowshipReferendumCreateWithoutPreimageInput {
  trackNumber: Int!
  origin: String!
  preimageHash: String!
  referendumId: Int!
...
input FellowshipReferendumCreateWithoutReferendumStatusInput {
  trackNumber: Int!
  origin: String!
  preimage: PreimageV2CreateOneWithoutFellowshipreferendumInput
  preimageHash: String!
...
type FellowshipReferendumEdge {
  node: FellowshipReferendum!
  cursor: String!
}

enum FellowshipReferendumOrderByInput {
  id_ASC
  id_DESC
  trackNumber_ASC
  trackNumber_DESC
...
type FellowshipReferendumPreviousValues {
  id: Int!
  trackNumber: Int!
  origin: String!
  preimageHash: String!
...
type FellowshipReferendumStatus {
  id: ID!
  blockNumber: BlockNumber!
...
type FellowshipReferendumStatusConnection {
  pageInfo: PageInfo!
  edges: [FellowshipReferendumStatusEdge]!
  aggregate: AggregateFellowshipReferendumStatus!
}

input FellowshipReferendumStatusCreateInput {
  id: ID
  blockNumber: BlockNumberCreateOneInput!
...
input FellowshipReferendumStatusCreateManyWithoutReferendumInput {
  create: [FellowshipReferendumStatusCreateWithoutReferendumInput!]
  connect: [FellowshipReferendumStatusWhereUniqueInput!]
}

input FellowshipReferendumStatusCreateWithoutReferendumInput {
  id: ID
  blockNumber: BlockNumberCreateOneInput!
  status: String!
  uniqueStatus: String!
...
type FellowshipReferendumStatusEdge {
  node: FellowshipReferendumStatus!
  cursor: String!
}

enum FellowshipReferendumStatusOrderByInput {
  id_ASC
  id_DESC
  status_ASC
  status_DESC
...
type FellowshipReferendumStatusPreviousValues {
  id: ID!
  status: String!
  uniqueStatus: String!
}

input FellowshipReferendumStatusScalarWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  uniqueStatus_ends_with: String
  uniqueStatus_not_ends_with: String
  AND: [FellowshipReferendumStatusScalarWhereInput!]
  OR: [FellowshipReferendumStatusScalarWhereInput!]
  NOT: [FellowshipReferendumStatusScalarWhereInput!]
}

type FellowshipReferendumStatusSubscriptionPayload {
  mutation: MutationType!
  node: FellowshipReferendumStatus
  updatedFields: [String!]
...
input FellowshipReferendumStatusSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: FellowshipReferendumStatusWhereInput
  AND: [FellowshipReferendumStatusSubscriptionWhereInput!]
  OR: [FellowshipReferendumStatusSubscriptionWhereInput!]
  NOT: [FellowshipReferendumStatusSubscriptionWhereInput!]
}

input FellowshipReferendumStatusUpdateInput {
  blockNumber: BlockNumberUpdateOneRequiredInput
  referendum: FellowshipReferendumUpdateOneRequiredWithoutReferendumStatusInput
  status: String
  uniqueStatus: String
}

input FellowshipReferendumStatusUpdateManyDataInput {
  status: String
  uniqueStatus: String
}

input FellowshipReferendumStatusUpdateManyMutationInput {
  status: String
  uniqueStatus: String
}

input FellowshipReferendumStatusUpdateManyWithoutReferendumInput {
  create: [FellowshipReferendumStatusCreateWithoutReferendumInput!]
  delete: [FellowshipReferendumStatusWhereUniqueInput!]
  connect: [FellowshipReferendumStatusWhereUniqueInput!]
  set: [FellowshipReferendumStatusWhereUniqueInput!]
  disconnect: [FellowshipReferendumStatusWhereUniqueInput!]
  update: [FellowshipReferendumStatusUpdateWithWhereUniqueWithoutReferendumInput!]
  upsert: [FellowshipReferendumStatusUpsertWithWhereUniqueWithoutReferendumInput!]
  deleteMany: [FellowshipReferendumStatusScalarWhereInput!]
  updateMany: [FellowshipReferendumStatusUpdateManyWithWhereNestedInput!]
}

input FellowshipReferendumStatusUpdateManyWithWhereNestedInput {
  where: FellowshipReferendumStatusScalarWhereInput!
  data: FellowshipReferendumStatusUpdateManyDataInput!
}

input FellowshipReferendumStatusUpdateWithoutReferendumDataInput {
  blockNumber: BlockNumberUpdateOneRequiredInput
  status: String
  uniqueStatus: String
}

input FellowshipReferendumStatusUpdateWithWhereUniqueWithoutReferendumInput {
  where: FellowshipReferendumStatusWhereUniqueInput!
  data: FellowshipReferendumStatusUpdateWithoutReferendumDataInput!
}

input FellowshipReferendumStatusUpsertWithWhereUniqueWithoutReferendumInput {
  where: FellowshipReferendumStatusWhereUniqueInput!
  update: FellowshipReferendumStatusUpdateWithoutReferendumDataInput!
  create: FellowshipReferendumStatusCreateWithoutReferendumInput!
}

input FellowshipReferendumStatusWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  id_not_ends_with: ID
  blockNumber: BlockNumberWhereInput
  referendum: FellowshipReferendumWhereInput
  status: String
  status_not: String
  status_in: [String!]
  status_not_in: [String!]
  ...
  uniqueStatus_ends_with: String
  uniqueStatus_not_ends_with: String
  AND: [FellowshipReferendumStatusWhereInput!]
  OR: [FellowshipReferendumStatusWhereInput!]
  NOT: [FellowshipReferendumStatusWhereInput!]
}

input FellowshipReferendumStatusWhereUniqueInput {
  id: ID
  uniqueStatus: String
}

type FellowshipReferendumSubscriptionPayload {
  mutation: MutationType!
  node: FellowshipReferendum
  updatedFields: [String!]
...
input FellowshipReferendumSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: FellowshipReferendumWhereInput
  AND: [FellowshipReferendumSubscriptionWhereInput!]
  OR: [FellowshipReferendumSubscriptionWhereInput!]
  NOT: [FellowshipReferendumSubscriptionWhereInput!]
}

input FellowshipReferendumUpdateInput {
  trackNumber: Int
  origin: String
  preimage: PreimageV2UpdateOneWithoutFellowshipreferendumInput
  preimageHash: String
  referendumId: Int
  referendumStatus: FellowshipReferendumStatusUpdateManyWithoutReferendumInput
  enactmentAt: String
  enactmentAfter: String
  submittedAt: String
  submitted: Json
...
input FellowshipReferendumUpdateManyMutationInput {
  trackNumber: Int
  origin: String
  preimageHash: String
  referendumId: Int
...
input FellowshipReferendumUpdateOneRequiredWithoutReferendumStatusInput {
  create: FellowshipReferendumCreateWithoutReferendumStatusInput
  update: FellowshipReferendumUpdateWithoutReferendumStatusDataInput
  upsert: FellowshipReferendumUpsertWithoutReferendumStatusInput
  connect: FellowshipReferendumWhereUniqueInput
}

input FellowshipReferendumUpdateOneWithoutPreimageInput {
  create: FellowshipReferendumCreateWithoutPreimageInput
  update: FellowshipReferendumUpdateWithoutPreimageDataInput
  upsert: FellowshipReferendumUpsertWithoutPreimageInput
  delete: Boolean
  disconnect: Boolean
  connect: FellowshipReferendumWhereUniqueInput
}

input FellowshipReferendumUpdateWithoutPreimageDataInput {
  trackNumber: Int
  origin: String
  preimageHash: String
  referendumId: Int
...
input FellowshipReferendumUpdateWithoutReferendumStatusDataInput {
  trackNumber: Int
  origin: String
  preimage: PreimageV2UpdateOneWithoutFellowshipreferendumInput
  preimageHash: String
...
input FellowshipReferendumUpsertWithoutPreimageInput {
  update: FellowshipReferendumUpdateWithoutPreimageDataInput!
  create: FellowshipReferendumCreateWithoutPreimageInput!
}

input FellowshipReferendumUpsertWithoutReferendumStatusInput {
  update: FellowshipReferendumUpdateWithoutReferendumStatusDataInput!
  create: FellowshipReferendumCreateWithoutReferendumStatusInput!
}

input FellowshipReferendumWhereInput {
  id: Int
  id_not: Int
  id_in: [Int!]
  id_not_in: [Int!]
  ...
  referendumStatus_every: FellowshipReferendumStatusWhereInput
  referendumStatus_some: FellowshipReferendumStatusWhereInput
  referendumStatus_none: FellowshipReferendumStatusWhereInput
  enactmentAt: String
  enactmentAt_not: String
  enactmentAt_in: [String!]
  enactmentAt_not_in: [String!]
  enactmentAt_lt: String
  enactmentAt_lte: String
  enactmentAt_gt: String
  enactmentAt_gte: String
  enactmentAt_contains: String
  enactmentAt_not_contains: String
  enactmentAt_starts_with: String
  ...
  AND: [FellowshipReferendumWhereInput!]
  OR: [FellowshipReferendumWhereInput!]
  NOT: [FellowshipReferendumWhereInput!]
}

input FellowshipReferendumWhereUniqueInput {
  id: Int
  referendumId: Int
}
...
type Mutation {
  ...
  createFellowshipReferendum(data: FellowshipReferendumCreateInput!): FellowshipReferendum!
  updateFellowshipReferendum(data: FellowshipReferendumUpdateInput!, where: FellowshipReferendumWhereUniqueInput!): FellowshipReferendum
  updateManyFellowshipReferendums(data: FellowshipReferendumUpdateManyMutationInput!, where: FellowshipReferendumWhereInput): BatchPayload!
  upsertFellowshipReferendum(where: FellowshipReferendumWhereUniqueInput!, create: FellowshipReferendumCreateInput!, update: FellowshipReferendumUpdateInput!): FellowshipReferendum!
  deleteFellowshipReferendum(where: FellowshipReferendumWhereUniqueInput!): FellowshipReferendum
  deleteManyFellowshipReferendums(where: FellowshipReferendumWhereInput): BatchPayload!
  createFellowshipReferendumStatus(data: FellowshipReferendumStatusCreateInput!): FellowshipReferendumStatus!
  updateFellowshipReferendumStatus(data: FellowshipReferendumStatusUpdateInput!, where: FellowshipReferendumStatusWhereUniqueInput!): FellowshipReferendumStatus
  updateManyFellowshipReferendumStatuses(data: FellowshipReferendumStatusUpdateManyMutationInput!, where: FellowshipReferendumStatusWhereInput): BatchPayload!
  upsertFellowshipReferendumStatus(where: FellowshipReferendumStatusWhereUniqueInput!, create: FellowshipReferendumStatusCreateInput!, update: FellowshipReferendumStatusUpdateInput!): FellowshipReferendumStatus!
  deleteFellowshipReferendumStatus(where: FellowshipReferendumStatusWhereUniqueInput!): FellowshipReferendumStatus
  deleteManyFellowshipReferendumStatuses(where: FellowshipReferendumStatusWhereInput): BatchPayload!
  ...
  createPreimageArgumentV2(data: PreimageArgumentV2CreateInput!): PreimageArgumentV2!
  updatePreimageArgumentV2(data: PreimageArgumentV2UpdateInput!, where: PreimageArgumentV2WhereUniqueInput!): PreimageArgumentV2
  updateManyPreimageArgumentV2s(data: PreimageArgumentV2UpdateManyMutationInput!, where: PreimageArgumentV2WhereInput): BatchPayload!
  upsertPreimageArgumentV2(where: PreimageArgumentV2WhereUniqueInput!, create: PreimageArgumentV2CreateInput!, update: PreimageArgumentV2UpdateInput!): PreimageArgumentV2!
  deletePreimageArgumentV2(where: PreimageArgumentV2WhereUniqueInput!): PreimageArgumentV2
  deleteManyPreimageArgumentV2s(where: PreimageArgumentV2WhereInput): BatchPayload!
  ...
  createPreimageStatusV2(data: PreimageStatusV2CreateInput!): PreimageStatusV2!
  updatePreimageStatusV2(data: PreimageStatusV2UpdateInput!, where: PreimageStatusV2WhereUniqueInput!): PreimageStatusV2
  updateManyPreimageStatusV2s(data: PreimageStatusV2UpdateManyMutationInput!, where: PreimageStatusV2WhereInput): BatchPayload!
  upsertPreimageStatusV2(where: PreimageStatusV2WhereUniqueInput!, create: PreimageStatusV2CreateInput!, update: PreimageStatusV2UpdateInput!): PreimageStatusV2!
  deletePreimageStatusV2(where: PreimageStatusV2WhereUniqueInput!): PreimageStatusV2
  deleteManyPreimageStatusV2s(where: PreimageStatusV2WhereInput): BatchPayload!
  createPreimageV2(data: PreimageV2CreateInput!): PreimageV2!
  updatePreimageV2(data: PreimageV2UpdateInput!, where: PreimageV2WhereUniqueInput!): PreimageV2
  updateManyPreimageV2s(data: PreimageV2UpdateManyMutationInput!, where: PreimageV2WhereInput): BatchPayload!
  upsertPreimageV2(where: PreimageV2WhereUniqueInput!, create: PreimageV2CreateInput!, update: PreimageV2UpdateInput!): PreimageV2!
  deletePreimageV2(where: PreimageV2WhereUniqueInput!): PreimageV2
  deleteManyPreimageV2s(where: PreimageV2WhereInput): BatchPayload!
  ...
  createReferendumStatusV2(data: ReferendumStatusV2CreateInput!): ReferendumStatusV2!
  updateReferendumStatusV2(data: ReferendumStatusV2UpdateInput!, where: ReferendumStatusV2WhereUniqueInput!): ReferendumStatusV2
  updateManyReferendumStatusV2s(data: ReferendumStatusV2UpdateManyMutationInput!, where: ReferendumStatusV2WhereInput): BatchPayload!
  upsertReferendumStatusV2(where: ReferendumStatusV2WhereUniqueInput!, create: ReferendumStatusV2CreateInput!, update: ReferendumStatusV2UpdateInput!): ReferendumStatusV2!
  deleteReferendumStatusV2(where: ReferendumStatusV2WhereUniqueInput!): ReferendumStatusV2
  deleteManyReferendumStatusV2s(where: ReferendumStatusV2WhereInput): BatchPayload!
  createReferendumV2(data: ReferendumV2CreateInput!): ReferendumV2!
  updateReferendumV2(data: ReferendumV2UpdateInput!, where: ReferendumV2WhereUniqueInput!): ReferendumV2
  updateManyReferendumV2s(data: ReferendumV2UpdateManyMutationInput!, where: ReferendumV2WhereInput): BatchPayload!
  upsertReferendumV2(where: ReferendumV2WhereUniqueInput!, create: ReferendumV2CreateInput!, update: ReferendumV2UpdateInput!): ReferendumV2!
  deleteReferendumV2(where: ReferendumV2WhereUniqueInput!): ReferendumV2
  deleteManyReferendumV2s(where: ReferendumV2WhereInput): BatchPayload!
...
type PreimageArgumentV2Connection {
  pageInfo: PageInfo!
  edges: [PreimageArgumentV2Edge]!
  aggregate: AggregatePreimageArgumentV2!
}

input PreimageArgumentV2CreateInput {
  id: ID
  name: String!
...
input PreimageArgumentV2CreateManyWithoutPreimageInput {
  create: [PreimageArgumentV2CreateWithoutPreimageInput!]
  connect: [PreimageArgumentV2WhereUniqueInput!]
}

input PreimageArgumentV2CreateWithoutPreimageInput {
  id: ID
  name: String!
  value: String!
}

type PreimageArgumentV2Edge {
  node: PreimageArgumentV2!
  cursor: String!
}

enum PreimageArgumentV2OrderByInput {
  id_ASC
  id_DESC
  name_ASC
  name_DESC
...
type PreimageArgumentV2PreviousValues {
  id: ID!
  name: String!
  value: String!
}

input PreimageArgumentV2ScalarWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  value_ends_with: String
  value_not_ends_with: String
  AND: [PreimageArgumentV2ScalarWhereInput!]
  OR: [PreimageArgumentV2ScalarWhereInput!]
  NOT: [PreimageArgumentV2ScalarWhereInput!]
}

type PreimageArgumentV2SubscriptionPayload {
  mutation: MutationType!
  node: PreimageArgumentV2
  updatedFields: [String!]
...
input PreimageArgumentV2SubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: PreimageArgumentV2WhereInput
  AND: [PreimageArgumentV2SubscriptionWhereInput!]
  OR: [PreimageArgumentV2SubscriptionWhereInput!]
  NOT: [PreimageArgumentV2SubscriptionWhereInput!]
}

input PreimageArgumentV2UpdateInput {
  name: String
  preimage: PreimageV2UpdateOneRequiredWithoutPreimageArgumentsInput
  value: String
}

input PreimageArgumentV2UpdateManyDataInput {
  name: String
  value: String
}

input PreimageArgumentV2UpdateManyMutationInput {
  name: String
  value: String
}

input PreimageArgumentV2UpdateManyWithoutPreimageInput {
  create: [PreimageArgumentV2CreateWithoutPreimageInput!]
  delete: [PreimageArgumentV2WhereUniqueInput!]
  connect: [PreimageArgumentV2WhereUniqueInput!]
  set: [PreimageArgumentV2WhereUniqueInput!]
  disconnect: [PreimageArgumentV2WhereUniqueInput!]
  update: [PreimageArgumentV2UpdateWithWhereUniqueWithoutPreimageInput!]
  upsert: [PreimageArgumentV2UpsertWithWhereUniqueWithoutPreimageInput!]
  deleteMany: [PreimageArgumentV2ScalarWhereInput!]
  updateMany: [PreimageArgumentV2UpdateManyWithWhereNestedInput!]
}

input PreimageArgumentV2UpdateManyWithWhereNestedInput {
  where: PreimageArgumentV2ScalarWhereInput!
  data: PreimageArgumentV2UpdateManyDataInput!
}

input PreimageArgumentV2UpdateWithoutPreimageDataInput {
  name: String
  value: String
}

input PreimageArgumentV2UpdateWithWhereUniqueWithoutPreimageInput {
  where: PreimageArgumentV2WhereUniqueInput!
  data: PreimageArgumentV2UpdateWithoutPreimageDataInput!
}

input PreimageArgumentV2UpsertWithWhereUniqueWithoutPreimageInput {
  where: PreimageArgumentV2WhereUniqueInput!
  update: PreimageArgumentV2UpdateWithoutPreimageDataInput!
  create: PreimageArgumentV2CreateWithoutPreimageInput!
}

input PreimageArgumentV2WhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  value_ends_with: String
  value_not_ends_with: String
  AND: [PreimageArgumentV2WhereInput!]
  OR: [PreimageArgumentV2WhereInput!]
  NOT: [PreimageArgumentV2WhereInput!]
}

input PreimageArgumentV2WhereUniqueInput {
  id: ID
}
...
type PreimageStatusV2Connection {
  pageInfo: PageInfo!
  edges: [PreimageStatusV2Edge]!
  aggregate: AggregatePreimageStatusV2!
}

input PreimageStatusV2CreateInput {
  id: ID
  blockNumber: BlockNumberCreateOneInput!
...
input PreimageStatusV2CreateManyWithoutPreimageInput {
  create: [PreimageStatusV2CreateWithoutPreimageInput!]
  connect: [PreimageStatusV2WhereUniqueInput!]
}

input PreimageStatusV2CreateWithoutPreimageInput {
  id: ID
  blockNumber: BlockNumberCreateOneInput!
  status: String!
}

type PreimageStatusV2Edge {
  node: PreimageStatusV2!
  cursor: String!
}

enum PreimageStatusV2OrderByInput {
  id_ASC
  id_DESC
  status_ASC
  status_DESC
...
type PreimageStatusV2PreviousValues {
  id: ID!
  status: String!
}

input PreimageStatusV2ScalarWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  status_ends_with: String
  status_not_ends_with: String
  AND: [PreimageStatusV2ScalarWhereInput!]
  OR: [PreimageStatusV2ScalarWhereInput!]
  NOT: [PreimageStatusV2ScalarWhereInput!]
}

type PreimageStatusV2SubscriptionPayload {
  mutation: MutationType!
  node: PreimageStatusV2
  updatedFields: [String!]
...
input PreimageStatusV2SubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: PreimageStatusV2WhereInput
  AND: [PreimageStatusV2SubscriptionWhereInput!]
  OR: [PreimageStatusV2SubscriptionWhereInput!]
  NOT: [PreimageStatusV2SubscriptionWhereInput!]
}

input PreimageStatusV2UpdateInput {
  blockNumber: BlockNumberUpdateOneRequiredInput
  preimage: PreimageV2UpdateOneRequiredWithoutPreimageStatusInput
  status: String
}

input PreimageStatusV2UpdateManyDataInput {
  status: String
}

input PreimageStatusV2UpdateManyMutationInput {
  status: String
}

input PreimageStatusV2UpdateManyWithoutPreimageInput {
  create: [PreimageStatusV2CreateWithoutPreimageInput!]
  delete: [PreimageStatusV2WhereUniqueInput!]
  connect: [PreimageStatusV2WhereUniqueInput!]
  set: [PreimageStatusV2WhereUniqueInput!]
  disconnect: [PreimageStatusV2WhereUniqueInput!]
  update: [PreimageStatusV2UpdateWithWhereUniqueWithoutPreimageInput!]
  upsert: [PreimageStatusV2UpsertWithWhereUniqueWithoutPreimageInput!]
  deleteMany: [PreimageStatusV2ScalarWhereInput!]
  updateMany: [PreimageStatusV2UpdateManyWithWhereNestedInput!]
}

input PreimageStatusV2UpdateManyWithWhereNestedInput {
  where: PreimageStatusV2ScalarWhereInput!
  data: PreimageStatusV2UpdateManyDataInput!
}

input PreimageStatusV2UpdateWithoutPreimageDataInput {
  blockNumber: BlockNumberUpdateOneRequiredInput
  status: String
}

input PreimageStatusV2UpdateWithWhereUniqueWithoutPreimageInput {
  where: PreimageStatusV2WhereUniqueInput!
  data: PreimageStatusV2UpdateWithoutPreimageDataInput!
}

input PreimageStatusV2UpsertWithWhereUniqueWithoutPreimageInput {
  where: PreimageStatusV2WhereUniqueInput!
  update: PreimageStatusV2UpdateWithoutPreimageDataInput!
  create: PreimageStatusV2CreateWithoutPreimageInput!
}

input PreimageStatusV2WhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  status_ends_with: String
  status_not_ends_with: String
  AND: [PreimageStatusV2WhereInput!]
  OR: [PreimageStatusV2WhereInput!]
  NOT: [PreimageStatusV2WhereInput!]
}

input PreimageStatusV2WhereUniqueInput {
  id: ID
}
...
input PreimageV2CreateInput {
  ...
  fellowshipreferendum: FellowshipReferendumCreateOneWithoutPreimageInput
  section: String!
  length: Int!
}

input PreimageV2CreateOneWithoutFellowshipreferendumInput {
  create: PreimageV2CreateWithoutFellowshipreferendumInput
  connect: PreimageV2WhereUniqueInput
}
...
input PreimageV2CreateOneWithoutPreimageStatusInput {
  create: PreimageV2CreateWithoutPreimageStatusInput
  connect: PreimageV2WhereUniqueInput
}

input PreimageV2CreateOneWithoutReferendumInput {
  create: PreimageV2CreateWithoutReferendumInput
  connect: PreimageV2WhereUniqueInput
}

input PreimageV2CreateWithoutFellowshipreferendumInput {
  id: ID
  author: String!
  depositAmount: String
  hash: String!
...
input PreimageV2SubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: PreimageV2WhereInput
  AND: [PreimageV2SubscriptionWhereInput!]
  OR: [PreimageV2SubscriptionWhereInput!]
  NOT: [PreimageV2SubscriptionWhereInput!]
}

input PreimageV2UpdateInput {
  author: String
  depositAmount: String
  hash: String
  metaDescription: String
  ...
  fellowshipreferendum: FellowshipReferendumUpdateOneWithoutPreimageInput
  section: String
  length: Int
}
...
input PreimageV2UpdateOneRequiredWithoutPreimageArgumentsInput {
  ...
  upsert: PreimageV2UpsertWithoutPreimageArgumentsInput
  connect: PreimageV2WhereUniqueInput
}

input PreimageV2UpdateOneRequiredWithoutPreimageStatusInput {
  create: PreimageV2CreateWithoutPreimageStatusInput
  update: PreimageV2UpdateWithoutPreimageStatusDataInput
  upsert: PreimageV2UpsertWithoutPreimageStatusInput
  connect: PreimageV2WhereUniqueInput
}

input PreimageV2UpdateOneWithoutFellowshipreferendumInput {
  create: PreimageV2CreateWithoutFellowshipreferendumInput
  update: PreimageV2UpdateWithoutFellowshipreferendumDataInput
  upsert: PreimageV2UpsertWithoutFellowshipreferendumInput
  delete: Boolean
  disconnect: Boolean
  connect: PreimageV2WhereUniqueInput
}

input PreimageV2UpdateOneWithoutReferendumInput {
  create: PreimageV2CreateWithoutReferendumInput
  update: PreimageV2UpdateWithoutReferendumDataInput
  upsert: PreimageV2UpsertWithoutReferendumInput
  delete: Boolean
  disconnect: Boolean
  connect: PreimageV2WhereUniqueInput
}

input PreimageV2UpdateWithoutFellowshipreferendumDataInput {
  author: String
  depositAmount: String
  hash: String
  metaDescription: String
...
input PreimageV2UpdateWithoutPreimageArgumentsDataInput {
  author: String
  depositAmount: String
  hash: String
  metaDescription: String
...
input PreimageV2UpsertWithoutFellowshipreferendumInput {
  update: PreimageV2UpdateWithoutFellowshipreferendumDataInput!
  create: PreimageV2CreateWithoutFellowshipreferendumInput!
}
...
input PreimageV2UpsertWithoutPreimageStatusInput {
  update: PreimageV2UpdateWithoutPreimageStatusDataInput!
  create: PreimageV2CreateWithoutPreimageStatusInput!
}

input PreimageV2UpsertWithoutReferendumInput {
  update: PreimageV2UpdateWithoutReferendumDataInput!
  create: PreimageV2CreateWithoutReferendumInput!
}

input PreimageV2WhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  preimageStatus_every: PreimageStatusV2WhereInput
  preimageStatus_some: PreimageStatusV2WhereInput
  preimageStatus_none: PreimageStatusV2WhereInput
  referendum: ReferendumV2WhereInput
  fellowshipreferendum: FellowshipReferendumWhereInput
  section: String
  section_not: String
  section_in: [String!]
  section_not_in: [String!]
...
input PreimageV2WhereUniqueInput {
  id: ID
}
...
type Query {
  ...
  fellowshipReferendum(where: FellowshipReferendumWhereUniqueInput!): FellowshipReferendum
  fellowshipReferendums(where: FellowshipReferendumWhereInput, orderBy: FellowshipReferendumOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [FellowshipReferendum]!
  fellowshipReferendumsConnection(where: FellowshipReferendumWhereInput, orderBy: FellowshipReferendumOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): FellowshipReferendumConnection!
  fellowshipReferendumStatus(where: FellowshipReferendumStatusWhereUniqueInput!): FellowshipReferendumStatus
  fellowshipReferendumStatuses(where: FellowshipReferendumStatusWhereInput, orderBy: FellowshipReferendumStatusOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [FellowshipReferendumStatus]!
  fellowshipReferendumStatusesConnection(where: FellowshipReferendumStatusWhereInput, orderBy: FellowshipReferendumStatusOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): FellowshipReferendumStatusConnection!
  ...
  preimageArgumentV2(where: PreimageArgumentV2WhereUniqueInput!): PreimageArgumentV2
  preimageArgumentV2s(where: PreimageArgumentV2WhereInput, orderBy: PreimageArgumentV2OrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [PreimageArgumentV2]!
  preimageArgumentV2sConnection(where: PreimageArgumentV2WhereInput, orderBy: PreimageArgumentV2OrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): PreimageArgumentV2Connection!
  ...
  preimageStatusV2(where: PreimageStatusV2WhereUniqueInput!): PreimageStatusV2
  preimageStatusV2s(where: PreimageStatusV2WhereInput, orderBy: PreimageStatusV2OrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [PreimageStatusV2]!
  preimageStatusV2sConnection(where: PreimageStatusV2WhereInput, orderBy: PreimageStatusV2OrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): PreimageStatusV2Connection!
  preimageV2(where: PreimageV2WhereUniqueInput!): PreimageV2
  preimageV2s(where: PreimageV2WhereInput, orderBy: PreimageV2OrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [PreimageV2]!
  preimageV2sConnection(where: PreimageV2WhereInput, orderBy: PreimageV2OrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): PreimageV2Connection!
  ...
  referendumStatusV2(where: ReferendumStatusV2WhereUniqueInput!): ReferendumStatusV2
  referendumStatusV2s(where: ReferendumStatusV2WhereInput, orderBy: ReferendumStatusV2OrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [ReferendumStatusV2]!
  referendumStatusV2sConnection(where: ReferendumStatusV2WhereInput, orderBy: ReferendumStatusV2OrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): ReferendumStatusV2Connection!
  referendumV2(where: ReferendumV2WhereUniqueInput!): ReferendumV2
  referendumV2s(where: ReferendumV2WhereInput, orderBy: ReferendumV2OrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [ReferendumV2]!
  referendumV2sConnection(where: ReferendumV2WhereInput, orderBy: ReferendumV2OrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): ReferendumV2Connection!
...
type ReferendumStatusV2Connection {
  pageInfo: PageInfo!
  edges: [ReferendumStatusV2Edge]!
  aggregate: AggregateReferendumStatusV2!
}

input ReferendumStatusV2CreateInput {
  id: ID
  blockNumber: BlockNumberCreateOneInput!
...
input ReferendumStatusV2CreateManyWithoutReferendumInput {
  create: [ReferendumStatusV2CreateWithoutReferendumInput!]
  connect: [ReferendumStatusV2WhereUniqueInput!]
}

input ReferendumStatusV2CreateWithoutReferendumInput {
  id: ID
  blockNumber: BlockNumberCreateOneInput!
  status: String!
  uniqueStatus: String!
...
type ReferendumStatusV2Edge {
  node: ReferendumStatusV2!
  cursor: String!
}

enum ReferendumStatusV2OrderByInput {
  id_ASC
  id_DESC
  status_ASC
  status_DESC
...
type ReferendumStatusV2PreviousValues {
  id: ID!
  status: String!
  uniqueStatus: String!
}

input ReferendumStatusV2ScalarWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  uniqueStatus_ends_with: String
  uniqueStatus_not_ends_with: String
  AND: [ReferendumStatusV2ScalarWhereInput!]
  OR: [ReferendumStatusV2ScalarWhereInput!]
  NOT: [ReferendumStatusV2ScalarWhereInput!]
}

type ReferendumStatusV2SubscriptionPayload {
  mutation: MutationType!
  node: ReferendumStatusV2
  updatedFields: [String!]
...
input ReferendumStatusV2SubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: ReferendumStatusV2WhereInput
  AND: [ReferendumStatusV2SubscriptionWhereInput!]
  OR: [ReferendumStatusV2SubscriptionWhereInput!]
  NOT: [ReferendumStatusV2SubscriptionWhereInput!]
}

input ReferendumStatusV2UpdateInput {
  blockNumber: BlockNumberUpdateOneRequiredInput
  referendum: ReferendumV2UpdateOneRequiredWithoutReferendumStatusInput
  status: String
  uniqueStatus: String
}

input ReferendumStatusV2UpdateManyDataInput {
  status: String
  uniqueStatus: String
}

input ReferendumStatusV2UpdateManyMutationInput {
  status: String
  uniqueStatus: String
}

input ReferendumStatusV2UpdateManyWithoutReferendumInput {
  create: [ReferendumStatusV2CreateWithoutReferendumInput!]
  delete: [ReferendumStatusV2WhereUniqueInput!]
  connect: [ReferendumStatusV2WhereUniqueInput!]
  set: [ReferendumStatusV2WhereUniqueInput!]
  disconnect: [ReferendumStatusV2WhereUniqueInput!]
  update: [ReferendumStatusV2UpdateWithWhereUniqueWithoutReferendumInput!]
  upsert: [ReferendumStatusV2UpsertWithWhereUniqueWithoutReferendumInput!]
  deleteMany: [ReferendumStatusV2ScalarWhereInput!]
  updateMany: [ReferendumStatusV2UpdateManyWithWhereNestedInput!]
}

input ReferendumStatusV2UpdateManyWithWhereNestedInput {
  where: ReferendumStatusV2ScalarWhereInput!
  data: ReferendumStatusV2UpdateManyDataInput!
}

input ReferendumStatusV2UpdateWithoutReferendumDataInput {
  blockNumber: BlockNumberUpdateOneRequiredInput
  status: String
  uniqueStatus: String
}

input ReferendumStatusV2UpdateWithWhereUniqueWithoutReferendumInput {
  where: ReferendumStatusV2WhereUniqueInput!
  data: ReferendumStatusV2UpdateWithoutReferendumDataInput!
}

input ReferendumStatusV2UpsertWithWhereUniqueWithoutReferendumInput {
  where: ReferendumStatusV2WhereUniqueInput!
  update: ReferendumStatusV2UpdateWithoutReferendumDataInput!
  create: ReferendumStatusV2CreateWithoutReferendumInput!
}

input ReferendumStatusV2WhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  uniqueStatus_ends_with: String
  uniqueStatus_not_ends_with: String
  AND: [ReferendumStatusV2WhereInput!]
  OR: [ReferendumStatusV2WhereInput!]
  NOT: [ReferendumStatusV2WhereInput!]
}

input ReferendumStatusV2WhereUniqueInput {
  id: ID
  uniqueStatus: String
}
...
input ReferendumV2CreateOneWithoutPreimageInput {
  ...
  connect: ReferendumV2WhereUniqueInput
}

input ReferendumV2CreateOneWithoutReferendumStatusInput {
...
input ReferendumV2SubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: ReferendumV2WhereInput
  AND: [ReferendumV2SubscriptionWhereInput!]
  OR: [ReferendumV2SubscriptionWhereInput!]
  NOT: [ReferendumV2SubscriptionWhereInput!]
}
...
input ReferendumV2UpdateOneRequiredWithoutReferendumStatusInput {
  ...
  upsert: ReferendumV2UpsertWithoutReferendumStatusInput
  connect: ReferendumV2WhereUniqueInput
}

input ReferendumV2UpdateOneWithoutPreimageInput {
  create: ReferendumV2CreateWithoutPreimageInput
  update: ReferendumV2UpdateWithoutPreimageDataInput
  upsert: ReferendumV2UpsertWithoutPreimageInput
  delete: Boolean
  disconnect: Boolean
  connect: ReferendumV2WhereUniqueInput
}
...
input ReferendumV2UpsertWithoutReferendumStatusInput {
  update: ReferendumV2UpdateWithoutReferendumStatusDataInput!
  create: ReferendumV2CreateWithoutReferendumStatusInput!
}

input ReferendumV2WhereInput {
  id: Int
  id_not: Int
  id_in: [Int!]
  id_not_in: [Int!]
  ...
  referendumId_gt: Int
  referendumId_gte: Int
  referendumStatus_every: ReferendumStatusV2WhereInput
  referendumStatus_some: ReferendumStatusV2WhereInput
  referendumStatus_none: ReferendumStatusV2WhereInput
  enactmentAt: String
  enactmentAt_not: String
  enactmentAt_in: [String!]
  enactmentAt_not_in: [String!]
...
input ReferendumV2WhereUniqueInput {
  id: Int
  referendumId: Int
}
...
type Subscription {
  ...
  fellowshipReferendum(where: FellowshipReferendumSubscriptionWhereInput): FellowshipReferendumSubscriptionPayload
  fellowshipReferendumStatus(where: FellowshipReferendumStatusSubscriptionWhereInput): FellowshipReferendumStatusSubscriptionPayload
  ...
  preimageArgumentV2(where: PreimageArgumentV2SubscriptionWhereInput): PreimageArgumentV2SubscriptionPayload
  preimageStatus(where: PreimageStatusSubscriptionWhereInput): PreimageStatusSubscriptionPayload
  preimageStatusV2(where: PreimageStatusV2SubscriptionWhereInput): PreimageStatusV2SubscriptionPayload
  preimageV2(where: PreimageV2SubscriptionWhereInput): PreimageV2SubscriptionPayload
  ...
  referendumStatusV2(where: ReferendumStatusV2SubscriptionWhereInput): ReferendumStatusV2SubscriptionPayload
  referendumV2(where: ReferendumV2SubscriptionWhereInput): ReferendumV2SubscriptionPayload
