...
const polkadot_network = process.env.POLKADOT_NETWORK || "https://polkadot.polkassembly.io/v1/graphql"
const kusama_network = process.env.KUSAMA_NETWORK || "https://kusama.polkassembly.io/v1/graphql"

let data_subject = "Error while fetching data";
let data_title = "Error while fetching. The api was not able to return data or returned 0 objects. \n"
