...
import { useAllTipPostsQuery, useTipProposalCountQuery } from '../../../generated/graphql';
...
const TipContainer = ({ className, limit }:Props) => {
	...
	const { data: countData, loading: countLoading,  refetch: countRefetch } = useTipProposalCountQuery({ variables: {
		postTopic: post_topic.TREASURY,
		postType: post_type.ON_CHAIN
	} });
