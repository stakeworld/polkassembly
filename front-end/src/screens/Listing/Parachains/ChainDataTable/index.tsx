		...
		render:(w3fGrant) => {
			...
			return (
				<>
					...
					</Tooltip> : <img src={w3fGrant?.terminated ? w3fRedLogo : w3fGrant?.milestoneText? w3fBlackLogo : w3fGreenLogo} height={34} width={34} alt='W3F Logo' />}
				</>
			);},
		title: 'W3F'
	},
	...
	},
	{
		...
		render:( githubLink ) => (
			<a href={githubLink} target='_blank' rel='noreferrer'>
				<img src={githubLogo} height={34} width={34} alt='github logo' />
			</a>
		),
		title: 'Github'
	}
