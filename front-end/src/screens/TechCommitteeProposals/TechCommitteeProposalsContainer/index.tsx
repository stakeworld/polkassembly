...
import { useAllTechCommitteeProposalPostsQuery, useTechCommitteeProposalCountQuery } from '../../../generated/graphql';
...
const TechCommitteeProposalsContainer = ({ className, limit }:Props) => {
	...
	const { data: countData, loading:countLoading, refetch:countRefetch } = useTechCommitteeProposalCountQuery({ variables: {
		postType: post_type.ON_CHAIN
	} });
