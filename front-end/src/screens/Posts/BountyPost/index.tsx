...
import { useBountyPostAndCommentsLazyQuery } from 'src/generated/graphql';
...
const BountyPost = () => {
	...
	const [getData, { called, data, error, refetch }] = useBountyPostAndCommentsLazyQuery({ variables: { 'id': idNumber } });
