...
import { useTechCommitteeProposalPostAndCommentsLazyQuery } from 'src/generated/graphql';
...
const TechCommProposalPost = () => {
	...
	const [getData, { called, data, error, refetch }] = useTechCommitteeProposalPostAndCommentsLazyQuery({ variables: { 'id': idNumber } });
